...
site.addsitedir('/home/nkannielai/webapps/django/env/lib/python3.6/site-packages')
os.environ.setdefault("DJANGO_SETTINGS_MODULE", "settings")

activate_this = os.path.expanduser("/home/nkannielai/webapps/django/env/bin/activate_this.py")
